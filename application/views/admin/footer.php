...
<script src="<?= base_url(); ?><?= base_url(); ?>plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- AdminLTE App -->
<script src="<?= base_url(); ?>static/js/app.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?= base_url(); ?>static/js/pages/dashboard.js"></script>
